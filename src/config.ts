...
export const MEDPLUM_PROJECT_ID = '9602358d-eeb0-4de8-bccf-e2438b5c9162'; // NOT Ovok projectId
export const MEDPLUM_CLIENT_ID = '9a872963-ab54-42da-a5bb-0bf29c5529ee'; // Ovok clientId
